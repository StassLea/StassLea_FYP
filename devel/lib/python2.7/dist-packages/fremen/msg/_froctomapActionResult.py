...
"""autogenerated by genpy from fremen/froctomapActionResult.msg. Do not edit."""
import codecs
import sys
...
class froctomapActionResult(genpy.Message):
  _md5sum = "6c57422c98377762059561764e9f0d70"
  _type = "fremen/froctomapActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fremen/froctomapResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(froctomapActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = fremen.msg.froctomapResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = fremen.msg.froctomapResult()
