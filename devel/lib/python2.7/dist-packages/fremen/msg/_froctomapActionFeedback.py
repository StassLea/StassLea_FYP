...
"""autogenerated by genpy from fremen/froctomapActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class froctomapActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "fremen/froctomapActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fremen/froctomapFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(froctomapActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = fremen.msg.froctomapFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = fremen.msg.froctomapFeedback()
