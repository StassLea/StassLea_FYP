...
if(NOT "/home/stass/StassLea_FYP/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fremenarray' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/stass/StassLea_FYP/src/fremen/FremenArray/${idir}'.  ${_report}")
    endif()
