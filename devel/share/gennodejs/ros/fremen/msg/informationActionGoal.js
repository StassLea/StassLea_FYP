...
let informationGoal = require('./informationGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class informationActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = informationGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new informationActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = informationGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new informationGoal()
    }
...
module.exports = informationActionGoal;
