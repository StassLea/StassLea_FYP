...
let froctomapGoal = require('./froctomapGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class froctomapActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = froctomapGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += froctomapGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new froctomapActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = froctomapGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new froctomapGoal()
    }
...
module.exports = froctomapActionGoal;
