...
let froctomapFeedback = require('./froctomapFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class froctomapActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new froctomapFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = froctomapFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new froctomapActionFeedback(null);
    ...
    data.feedback = froctomapFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new froctomapActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = froctomapFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new froctomapFeedback()
    }
...
module.exports = froctomapActionFeedback;
